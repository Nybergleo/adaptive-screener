...
IDENTITY_FIELDS = [
    FieldSpec(
        ...
        "name()",
        "text",
        "Description: Company/security display name. Output units: company or security name.",
        default_input=False,
    ),
    FieldSpec(
        "cntry_of_domicile",
        ...
        "cntry_of_domicile()",
        "text",
        "Description: Country where the company is legally domiciled. Output units: ISO-style country code.",
        default_input=False,
    ),
    FieldSpec(
        "crncy",
        ...
        "crncy()",
        "text",
        "Description: Main trading currency for the security. Output units: ISO currency code.",
        default_input=False,
    ),
    FieldSpec(
        "sector",
        ...
        "text",
        "Description: Bloomberg Industry Classification Standard level-1 grouping, the broadest classification label, used for sector-level attribution, benchmarking, and universe filtering. Output units: sector name.",
        default_input=False,
    ),
    FieldSpec(
        "industry_group",
        ...
        "text",
        "Description: BICS level-2 grouping, one step more granular than sector, useful for peer group construction and more targeted factor analysis. Output units: industry-group name.",
        default_input=False,
    ),
]
...
FIELD_CATALOG = [
    FieldSpec(
        ...
        "oper_margin(fpt=LTM)",
        "numeric",
        "Description: Operating profit as a fraction of revenue over the trailing twelve months; measures how efficiently a company converts sales into operating earnings before interest and tax. Output units: percent points (25 = 25%). Filter units: percent points.",
        default_min="10",
    ...
    FieldSpec(
        ...
        "numeric",
        "Description: Same as operating margin but adds back amortization of intangibles, giving a cleaner view of operating profitability for companies with significant acquired intangible assets. Output units: percent points (25 = 25%). Filter units: percent points.",
        default_min="11",
        format_type="percent_points",
    ),
    FieldSpec(
        ...
        "numeric",
        "Description: Operating profit before interest, tax, depreciation, and amortization as a fraction of revenue; a widely used proxy for cash generation capacity and the basis for most EV/EBITDA valuation multiples. Output units: percent points (25 = 25%). Filter units: percent points.",
        format_type="percent_points",
    ),
    FieldSpec(
        "margin_stability_pp",
        ...
        "numeric",
        "Description: Standard deviation of quarterly operating margin over a rolling window; a higher value indicates more volatile earnings quality, while a lower value signals consistent, predictable profitability. Output units: percentage points of margin standard deviation (4 = 4 pp). Filter units: percentage points. Window controls how many quarters are included.",
        default_max="4",
        format_type="percent_points",
    ),
    FieldSpec(
        ...
        "numeric",
        "Description: Price divided by a time-weighted blend of the current and next fiscal year EPS estimates, calibrated to represent exactly 12 months of forward earnings regardless of fiscal year position. Output units: valuation multiple (22.4 = 22.4x). Filter units: multiple.",
        default_max="25",
    ),
    FieldSpec(
        "ebit_ltm",
        ...
        "numeric",
        "Description: Absolute operating profit in currency terms over the trailing twelve months; the numerator of operating margin, useful for sizing earnings power in comparable company analysis. Output units: millions of {currency}. Filter units: millions of {currency}.",
    ),
    FieldSpec(
        "market_cap",
        ...
        "numeric",
        "Description: Total equity value of the company at current market prices, calculated from shares outstanding times price; the most common measure of company size and the denominator in yield-based valuation metrics. Output units: millions of {currency}. Filter units: millions of {currency}.",
        default_min="500",
    ),
    FieldSpec(
        "turnover",
        ...
        "numeric",
        "Description: Daily traded value of the security in currency terms; a liquidity measure used to assess how easily a position can be entered or exited without significant market impact. Output units: millions of {currency}. Filter units: millions of {currency}.",
    ),
    FieldSpec(
        "revenue_ltm",
        "LTM revenue",
        ...
        "numeric",
        "Description: Total top-line sales over the trailing twelve months; the starting point for margin analysis and a key input to revenue-based valuation multiples such as EV/Sales. Output units: millions of {currency}. Filter units: millions of {currency}.",
    ),
    FieldSpec(
        ...
        "free_cash_flow_yield",
        "numeric",
        "Description: Free cash flow per share divided by price; expresses how much cash a company generates relative to its market value, analogous to an earnings yield but based on actual cash rather than accounting profit. Output units: percent points (4 = 4%). Filter units: percent points.",
        format_type="percent_points",
    ),
    FieldSpec(
        "dividend_yield",
        ...
        "dividend_yield",
        "numeric",
        "Description: Annualized dividend per share divided by price; the income return component of total return, relevant for income-oriented screening and dividend discount valuation. Output units: percent points (1.5 = 1.5%). Filter units: percent points.",
        format_type="percent_points",
    ),
    FieldSpec(
        "return_on_capital",
        ...
        "return_on_capital_employed",
        "numeric",
        "Description: Operating profit divided by capital employed (debt plus equity), measuring how productively the company deploys its total invested capital; a key indicator of competitive advantage and management quality. Output units: percent points (322 = 322%). Filter units: percent points.",
        format_type="percent_points",
    ),
    FieldSpec(
        "sector_filter",
        ...
        "classification_name(BICS, 1)",
        "text",
        "Description: Bloomberg Industry Classification Standard level-1 grouping, the broadest classification label, used for sector-level attribution, benchmarking, and universe filtering. Output units: sector name. Filter units: exact text values. Text filters use exact equals or comma-separated in-list values.",
    ...
    FieldSpec(
        ...
        "classification_name(BICS, 2)",
        "text",
        "Description: BICS level-2 grouping, one step more granular than sector, useful for peer group construction and more targeted factor analysis. Output units: industry-group name. Filter units: exact text values. Text filters use exact equals or comma-separated in-list values.",
        default_output=False,
        format_type="text",
    ),
]
